...
df:['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'ingresos', 'año', 'mes', 'dia_semana', 'dia_semana_es', 'dia_mes',
       'nombre_dia_semana', 'es_fin_de_semana', 'es_festivo',
       'es_black_friday', 'es_cyber_monday', 'es_laborable', 'semana_año',
       'dia_año', 'es_primer_dia_mes', 'es_ultimo_dia_mes', 'trimestre',
       'es_primer_quincena', 'es_víspera_festivo', 'es_post_festivo',
...
inferencia_df:['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'dia_mes', 'dia_semana', 'dia_semana_es', 'nombre_dia_semana',
       'es_fin_de_semana', 'es_festivo', 'es_laborable', 'semana_año',
       'dia_año', 'es_primer_dia_mes', 'es_ultimo_dia_mes', 'trimestre',
       'es_primer_quincena', 'es_víspera_festivo', 'es_post_festivo',
       'es_black_friday', 'es_cyber_monday', 'unidades_vendidas_lag1',
